...
public class ReservasView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReservasView frame = new ReservasView(30);
	 ...
	 * Create the frame.
	 */
	public ReservasView(Integer idHuesped) {
		super("Reserva");
		
		this.reservaController = new ReservaController();
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/imagenes/aH-40px.png")));
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 910, 580);
		setResizable(false);
		...
		separator_1_3.setBounds(68, 505, 289, 2);
		...
		lblFormaPago.setBounds(68, 382, 187, 14);
		lblFormaPago.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblFormaPago);
		
		JLabel lblIdhuesped = new JLabel("ID HUESPED");
		lblIdhuesped.setForeground(SystemColor.textInactiveText);
		lblIdhuesped.setBounds(68, 461, 187, 14);
		lblIdhuesped.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblIdhuesped);
		...
		panel_1.setBounds(428, 0, 482, 580);
		...
		//txtFechaSalida.setDate(new java.util.Date());
		...
		txtValor.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		txtValor.setBorder(javax.swing.BorderFactory.createEmptyBorder());
		panel.add(txtValor);


		txtFormaPago = new JComboBox();
		txtFormaPago.setBounds(68, 408, 285, 33);
		txtFormaPago.setBackground(SystemColor.text);
		txtFormaPago.setBorder(new LineBorder(new Color(255, 245, 255), 1, true));
		txtFormaPago.setFont(new Font("Roboto", Font.PLAIN, 16));
		txtFormaPago.setModel(new DefaultComboBoxModel(new String[] {"Tarjeta de Crédito", "Tarjeta de Débito", "Dinero en efectivo"}));
		panel.add(txtFormaPago);

		txtIdHuesped = new JTextField(String.valueOf(idHuesped));
		txtIdHuesped.setBounds(78, 470, 289, 35);
		txtIdHuesped.setBackground(SystemColor.text);
		txtIdHuesped.setHorizontalAlignment(SwingConstants.LEFT);
		txtIdHuesped.setForeground(Color.BLACK);
		txtIdHuesped.setEditable(false);
		txtIdHuesped.setFont(new Font("Roboto Black", Font.PLAIN, 17));
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {	
					reservaController.guardar(new Reserva(new Date(txtFechaEntrada.getDate().getTime()),new Date(txtFechaSalida.getDate().getTime()),
							Double.valueOf(txtValor.getText()),txtFormaPago.getSelectedItem().toString(),Integer.parseInt(txtIdHuesped.getText())));
					//JOptionPane.showMessageDialog(null,calcularValor());
					dispose();
					Exito.mostrar();
		...
		btnguardar.setBounds(238, 530, 122, 35);
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"	
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    ...
	    private void calcularValor(JDateChooser fechaEntrada, JDateChooser fechaSalida) {
	    	...
	    	int precioDia = 60000; //Precio en pesos colombiano de un dia en el hotel
	    	...
	    	if(fechaEntrada.getDate() != null && fechaSalida.getDate() != null) {
				...
				int precio = (int)Math.floor(diferencia/(1000*60*60*24));
				System.out.println(precio);
		    	precio = precio*precioDia;
